 ...
 * @author ALDO
 */
public class praktikum3_3_GUI extends javax.swing.JFrame {

    
    public praktikum3_3_GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(praktikum3_3_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new praktikum3_3_GUI().setVisible(true);
            }
        });
    }
