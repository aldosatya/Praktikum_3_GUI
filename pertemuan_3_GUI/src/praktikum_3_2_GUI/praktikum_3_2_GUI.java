 ...
 * @author ALDO
 */
public class praktikum_3_2_GUI extends javax.swing.JFrame {

    
    public praktikum_3_2_GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(praktikum_3_2_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new praktikum_3_2_GUI().setVisible(true);
            }
        });
    }
